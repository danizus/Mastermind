...
export default function Header() {
  return (
    <header className="site-header absolute left-0 right-0 top-0 z-40 py-5">
      <div className="container flex items-center justify-between">
        <div className="grid w-full grid-cols-12 items-center justify-between gap-x-6">
          <div className="col-span-6 md:col-span-2">
            <Link href="/" className="site-logo bg-primary text-white">
